					...
					<s:iterator id="orders" value="#request.ordersList">
						<tr style="background-color:#FFFFFF;">
							...
							<td><s:if test="#orders.orderState=='未处理'">
									<a href="/Restraunt/handleOrders?oid=${oid}"><img
										src="images/handle.gif" width="12" height="12" /></a>
								</s:if></td>
						</tr>
					</s:iterator>
					...
					<table align="right">
						<tr>
							...
							<td width="80"><s:if test="pager.curPage>1">
									<a
										href='/Restraunt/toManageOrders?pager.curPage=1&orders.oid=${requestScope.oid}&orders.orderState=${requestScope.orderState}'>首页</a>&nbsp;&nbsp;
				<a
										href='/Restraunt/toManageOrders?pager.curPage=${pager.curPage-1 }&orders.oid=${requestScope.oid}&orders.orderState=${requestScope.orderState}'>上一页</a>
								</s:if></td>
							<td width="80"><s:if test="pager.curPage < pager.pageCount">
									<a
										href='/Restraunt/toManageOrders?pager.curPage=${pager.curPage+1}&orders.oid=${requestScope.oid}&orders.orderState=${requestScope.orderState}'>下一页</a>&nbsp;&nbsp;
				<a
										href='/Restraunt/toManageOrders?pager.curPage=${pager.pageCount }&orders.oid=${requestScope.oid}&orders.orderState=${requestScope.orderState}'>尾页</a>
								</s:if></td>
