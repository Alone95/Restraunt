						...
						<tr style="background-color:#FFFFFF;">						  
							...
							<td>
							    <s:if test="#orders.orderState=='未处理'">
								  <a href="/Restraunt/handleOrders?oid=${oid}"><img src="images/handle.gif"
	  ...
	  <tr>
		...
		<td width="80">
			<s:if test="pager.curPage>1">
				<A href='/Restraunt/toManageOrders?pager.curPage=1&orders.oid=${requestScope.oid}&orders.orderState=${requestScope.orderState}'>首页</A>&nbsp;&nbsp;
				<A href='/Restraunt/toManageOrders?pager.curPage=${pager.curPage-1 }&orders.oid=${requestScope.oid}&orders.orderState=${requestScope.orderState}'>上一页</A>
			</s:if>
		</td>
		<td width="80">
			<s:if test="pager.curPage < pager.pageCount">
				<A href='/Restraunt/toManageOrders?pager.curPage=${pager.curPage+1}&orders.oid=${requestScope.oid}&orders.orderState=${requestScope.orderState}'>下一页</A>&nbsp;&nbsp;
				<A href='/Restraunt/toManageOrders?pager.curPage=${pager.pageCount }&orders.oid=${requestScope.oid}&orders.orderState=${requestScope.orderState}'>尾页</A>
			</s:if>
		</td>
